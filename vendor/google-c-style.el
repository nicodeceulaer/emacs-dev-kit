...
;; the more
;; elegant solution of composing a list of lineup functions or
;; quantities with
...
Suitable for inclusion in `c-offsets-alist'."
    (save-excursion
      ...
      (back-to-indentation)
          ;; We are making a reasonable assumption that if there is a
      ;; control
          ;; structure to indent past, it has to be at the beginning
      ;; of the line.
...
(defconst google-c-style
  `((c-recognize-knr-p . nil)
    (c-enable-xemacs-performance-kludge-p . t) ; speed up indentation
                                        ; in XEmacs
    (c-basic-offset . 2)
